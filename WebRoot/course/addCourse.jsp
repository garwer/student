  ...
  <TITLE>学生管理</TITLE>
	...
	function getAllCourse() {
	    ...
	    $table.bootstrapTable({
	        ...
	        url: "/student/getCourse.do?method=findAllCourses", //获取数据的Servlet地址
	        toggle:'table',
	        cache:false,
	        dataType: "json",
	        toolbar: '#toolbar', 
	...
	function sureDelCollect() {
		var url = "/student/getCourse.do?method=findAllCourses";
...
<div id = "menuDivId" style="display:block"></div>
         <div class="modal-body" >
             <div style="margin-top:20px">
		                <legend>
		                	 <h4 class="modal-title text-info" >课题管理</h4>
		                </legend>  
