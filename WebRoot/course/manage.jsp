       					...
       					<div class="per-center-div">
		       				...
		       				<div>
		       					<div class="col-xs-6">
		       						...
		       						<div class="release-script" id = "addStudent"  >添加学生</div>
		       						</div>
		       					</div>
		       					<div class="col-xs-6">
		       						<div class="script-btn">
		       						<div class="script script-img1">&nbsp;&nbsp;&nbsp;&nbsp;</div>
		       						<div class="release-script" id = "addCourse"  >添加课程</div>
		       						</div>
		       					</div>
		       				</div>
	       				</div>
